...
exports.getProgramsForProjects =
  exports.createWatchProgram =
  exports.clearWatchCaches =
    void 0;
...
function updateCachedFileList(tsconfigPath, program, extra) {
  const fileList = extra.EXPERIMENTAL_useSourceOfProjectReferenceRedirect
    ? new Set(
        program
          .getSourceFiles()
          .map((sf) => (0, shared_1.getCanonicalFileName)(sf.fileName))
      )
    : new Set(
        program
          .getRootFileNames()
          .map((f) => (0, shared_1.getCanonicalFileName)(f))
      );
...
function getProgramsForProjects(code, filePathIn, extra) {
  ...
  for (const [tsconfigPath, existingWatch] of knownWatchProgramMap.entries()) {
    ...
    if (fileList.has(filePath)) {
      ...
      updatedProgram =
        updatedProgram !== null && updatedProgram !== void 0
          ? updatedProgram
...
function createWatchProgram(tsconfigPath, extra) {
  ...
  if (extra.moduleResolver) {
    watchCompilerHost.resolveModuleNames = (0, shared_1.getModuleResolver)(
...
function maybeInvalidateProgram(existingWatch, filePath, tsconfigPath) {
  ...
  const deletedFile = rootFilenames.find(
    (file) => !fs_1.default.existsSync(file)
  );
  if (!deletedFile) {
