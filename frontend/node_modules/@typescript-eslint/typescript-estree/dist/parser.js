...
exports.clearParseAndGenerateServicesCalls =
  exports.clearProgramCache =
  exports.parseWithNodeMaps =
...
function getProgramAndAST(
  ...
  return (
    (programInstances &&
      (0, useProvidedPrograms_1.useProvidedPrograms)(
        programInstances,
        extra
      )) ||
    (shouldProvideParserServices &&
...
function prepareAndTransformProjects(projectsInput, ignoreListInput) {
  ...
  const nonGlobProjects = sanitizedProjects.filter(
    (project) => !(0, is_glob_1.default)(project)
  );
  ...
  const uniqueCanonicalProjectPaths = new Set(
    nonGlobProjects
      .concat(
        (0, globby_1.sync)([...globProjects, ...ignoreListInput], {
...
function parseAndGenerateServices(code, options) {
      ...
      *[Symbol.iterator]() {
        for (const configFile of extra.projects) {
          ...
          if (existingProgram) {
            ...
            const newProgram = (0,
            useProvidedPrograms_1.createProgramFromConfigFile)(configFile);
  ...
  if (program && extra.errorOnTypeScriptSyntacticAndSemanticIssues) {
    const error = (0,
    semantic_or_syntactic_errors_1.getFirstSemanticOrSyntacticError)(
      program,
      ast
    );
    if (error) {
