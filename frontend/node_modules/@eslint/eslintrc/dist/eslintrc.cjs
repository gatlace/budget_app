...
class ConfigValidator {
  ...
  validateRuleSeverity(options) {
    ...
    throw new Error(
      `\tSeverity should be one of the following: 0 = off, 1 = warn, 2 = error (you passed '${util__default[
        "default"
      ]
        .inspect(severity)
        .replace(/'/gu, '"')
    ...
    for (const envName of Object.keys(eslintrcConfig.env)) {
      ...
      if (eslintrcConfig.env[envName]) {
        ...
        if (environments.has(envName)) {
          ...
          configs.unshift(
            ...translateESLintRC(environments.get(envName), {
              resolveConfigRelativeTo,
              resolvePluginsRelativeTo,
            })
          );
          ...
          configs.push(
            ...translateESLintRC(pluginEnvironments.get(envName), {
              resolveConfigRelativeTo,
              resolvePluginsRelativeTo,
            })
          );
